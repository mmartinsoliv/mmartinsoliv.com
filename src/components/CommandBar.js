...
export default function CommandBar(props) {
    ...
    const actions = [
        ...
        },
        {
            ...
            section: 'General',
            perform: () =>
              window.open('https://github.com/mmartinsoliv/mmartinsoliv.com', '_blank'),
        ...
        },  
        {
            ...
            keywords: 'go-github',
            section: 'Follow',
            perform: () => window.open('https://github.com/mmartinsoliv', '_blank'),
        ...
        },
        {
            ...
            keywords: 'go-twitter',
            section: 'Follow',
            perform: () => window.open('https://twitter.com/mmartinsoliv', '_blank'),
        ...
        },
        {
            ...
            section: 'Follow',
            perform: () => window.open('https://linkedin.com/in/matheus-martins-78859b117', '_blank'),
        ...
        },
        {
            ...
            section: 'Follow',
            perform: () => window.open('https://instagram.com/mmartinsoliv', '_blank'),
